...
var orangethemesButtons=[
		{
			...
			fields:[{id:'text', name:'Text'},{id:'icon', name:'Icon', values:ot_icons()},{id:'href', name:'Link URL'},{id:'color', name:'Color', value:'b70900', colorpalette:true},{id:'textcolor', name:'Text Color', colorpalette:true},{id:'target', name:'Target', values:['Self', 'Blank']},{id:'side', name:'Icon Side', values:['Left', 'Right']},{id:'size', name:'Size', values:['Small', 'Big']}],
			generateHtml:function(obj){
				var code = obj.icon;
				var buttonTarget=obj.target==='Self'?'':'blank';
				return '[button link="'+obj.href+'" icon="'+code+'" size="'+obj.size.toLowerCase()+'" side="'+obj.side.toLowerCase()+'" target="'+buttonTarget+'" color="'+obj.color.toLowerCase()+'" textcolor="'+obj.textcolor.toLowerCase()+'"]'+obj.text+'[/button]';
		...
		},		
		{
			...
			title:'Spacer',
			allowSelection:false,
			fields:[{id:'style', name:'Style', values:['Spacer 1', 'Spacer 2', 'Spacer 3', 'Spacer 4']},{id:'icon', name:'Icon', values:ot_icons()},{id:'color', name:'Color<br/>(Except spacer 1)', value:'264C84', colorpalette:true, disabled:true }],
			generateHtml:function(obj){
				...
				return '[spacer'+colorAtr+' icon="'+obj.icon+'" style="'+spacerStyle+'"]';
		...
		},
		{
			...
			title:'Alert Box',
			allowSelection:false,
			fields:[{id:'text', name:'Text', textarea:true},{id:'color', name:'Color', color:"c24000", colorpalette:true},{id:'icon', name:'Icon', values:ot_icons()}],
			generateHtml:function(obj){
